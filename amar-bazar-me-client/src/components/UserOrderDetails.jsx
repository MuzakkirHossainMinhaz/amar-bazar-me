...
const UserOrderDetails = () => {
  ...
  return (
    <div className={`py-6 ${styles.section}`}>
      ...
      <div className="w-full flex items-center justify-between pt-4">
        <h5 className="text-[#00000084]">
          Order ID: <span className="font-semibold">#{data?._id?.slice(0, 8)}</span>
        </h5>
        <h5 className="text-[#00000084]">
          Placed on: <span className="font-semibold">{data?.createdAt?.slice(0, 10)}</span>
        </h5>
      </div>
      ...
      {/* review popup */}
      {
        open && (
          <div className="w-full fixed top-0 left-0 h-screen bg-[#0005] z-50 flex items-center justify-center">
            <div className="w-[50%] bg-white shadow rounded-md p-6">
              ...
              <div className="w-full flex items-center gap-3">
                ...
                />
                <div>
                  <div className="text-[21px] font-semibold">{selectedItem?.name}</div>
              ...
              <div
                className={`${styles.button} text-white !mb-0`}
