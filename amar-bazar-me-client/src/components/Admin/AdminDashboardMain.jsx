          ...
          <div className="w-full px-8 py-5">
            ...
            <div className="w-full flex flex-col gap-2 lg:flex-row">
              <div className="flex-1 bg-white shadow rounded p-4">
                ...
                <h5 className="pt-2 pl-[36px] text-[30px] font-[600] text-green-600">৳ {adminBalance}</h5>
              </div>
              ...
              <div className="flex-1 bg-white shadow rounded p-4">
                ...
                <h5 className="pt-2 pl-[36px] text-[30px] font-[600] text-cyan-600">{sellers && sellers.length}</h5>
              ...
              <div className="flex-1 bg-white shadow rounded p-4">
                ...
                <h5 className="pt-2 pl-[36px] text-[30px] font-[600] text-yellow-600">{adminOrders && adminOrders.length}</h5>
