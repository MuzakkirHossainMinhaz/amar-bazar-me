...
const ShopLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-3">
      <div className='bg-white sm:mx-auto sm:w-full sm:max-w-lg py-8 px-4 shadow sm:px-10 rounded-lg'>
        <div className="sm:mx-auto sm:w-full sm:max-w-lg flex flex-col items-center">
          ...
          <h2 className="mt-6 text-center text-xl font-semibold text-gray-900">Welcome to AmarBazar!<br />Please login your shop.</h2>
        </div>
          ...
          <div className="bg-white ">
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className={`${styles.noramlFlex} w-full`}>
                ...
                <Link to="/register_shop" className="text-blue-600 pl-2">
                  Register as shop
                </Link>
              </div>
            </form>
