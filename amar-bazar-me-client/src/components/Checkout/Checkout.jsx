...
const Checkout = () => {
  ...
  const paymentSubmit = () => {
    if (address1 === "" || address2 === "" || zipCode === null || country === "" || city === "" || shippingMethod === "") {
...
const ShippingInfo = ({
  ...
  return (
    <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
      ...
      <br />
      <h5 className="text-[18px] cursor-pointer inline-block hover:text-blue-700"
          ...
          <div>
            {
              user && user.addresses.map((item, index) => (
                <div className="w-full flex mt-1" key={index}>
                  ...
                  />
                  <label htmlFor={index}>{item.addressType}</label>
                </div>
              ))
            }
          </div>
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <input
          className={`w-full h-[40px] border border-blue-500 text-center text-blue-500 rounded-md mt-8 cursor-pointer`}
          required
          value="Apply code"
          type="submit"
        />
