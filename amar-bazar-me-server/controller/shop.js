...
// create shop
router.post("/create_shop", catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    try {
      await sendMail({
        email: seller.email,
        subject: "Activate Your Shop - AmarBazar",
...
// delete seller withdraw merthods -> seller
